...
likert_theme <-
  ...
  theme(text = element_text(size = 20),
        ...
        axis.title.y  = element_text(colour = "grey10", angle = 180, size=15, family = "arial"),
        axis.title.x  = element_text(colour = "grey10", size=15, family = "arial"),
...
y_title <- ggplot() + 
  ...
  geom_text(aes(x = 0.5, y = 0.5), label = "Wildlife category", angle = 90, size = 5) 
...
ggsave(plot = mix, filename = "v2/plot_section_2A_option3.png", width = 15, height = 9)
