---
title: "Appendix 'Wildlife health perceptions and monitoring in protected areas'"
author:
...
### Section 1: Perceptions regarding wildlife health importance in conservation and potential consequences of pathogen transmission among wildlife, domestic animals, and people.
...
#| eval: true
#| fig-align: center
#| fig-cap: Distribution of methods of documentation to register either sick, injured, or dead wildlife found during ranger patrols reported by protected area data managers.
...
### Section 3: Presence of domestic animals in protected areas, the documentation of their health status, and the perceived threats of domestic animals to conservation goals
...
### Section 1: Perceptions regarding wildlife health importance in conservation and potential consequences of pathogen transmission among wildlife, domestic animals, and people in local surveys and non-local surveys containing protected areas in local responses
...
section_1 =
  ...
  select(country,
         ...
         wildlife_path_affect_livestock,
         wildlife_path_affect_phealth) %>% 
  mutate(global_local="Local")) 


section_1$country<-paste0("country_",i) 
...
out<-kableExtra::kable(section_1,  
                       caption = paste0("Non-local and local responses for section 1 in country ", i),
                    col.names = 
                    c("Response\ncategory",
                      "Wildlife health\nis important",
                      "Human and livestock\npathogens can\nimpact wildlife\nhealth",
                      "Wildlife pathogens can\nimpact human health",
                      "Wildlife pathogens can\nimpact livestock health")) %>% column_spec(1:5, width = c("2cm", rep("3cm", 4))) %>% kable_styling(latex_options = "HOLD_position")  
  #                 table.attr = "quarto-disable-processing=true") %>% 
  # kable_styling(c("striped", "bordered"), full_width = FALSE)


assign(x = paste0("section_1", "_table", i), value = out)

}

get("section_1_table1")
get("section_1_table2")
get("section_1_table3")
get("section_1_table4")

#mget(paste0("section_1", "_table", 1:nrow(compare_global_versus_local)))

```

### Section 2: Overall frequency of encounters with dead, sick, or injured wildlife in protected areas and their documentation when found during patrols in local surveys and non-local surveys containing protected areas in local responses
...
section_2$country<-paste0("country_",i) 
...
out<-kableExtra::kable(section_2,  
                       caption = paste0("Non-local and local responses for section 2 in country ", i),
                    col.names = 
                    c("Response\ncategory",
                      "Dead wildlife\nencounter frequency",
                      "Dead wildlife\nfound in patrols\nis recorded",
                      ...
                      "Sick wildlife\nfound in patrols\nis recorded",
                      "Injured wildlife\nfound in patrols\nis recorded")) %>% column_spec(1:6, width = c("2cm", "3cm", "2cm", "3cm", rep("2cm", 2))) %>%  kable_styling(latex_options = "HOLD_position")
  #                 table.attr = "quarto-disable-processing=true") %>% 
  # kable_styling(c("striped", "bordered"), full_width = FALSE)


assign(x = paste0("section_2", "_table", i), value = out)

}

get("section_2_table1")
get("section_2_table2")
get("section_2_table3")
get("section_2_table4")


```

### Section 3: Presence of domestic animals in protected areas, the documentation of their health status, and the perceived threats of domestic animals to conservation goals in local surveys and non-local surveys containing protected areas in local responses
...
section_3$country<-paste0("country_",i) 
...
out<-kableExtra::kable(section_3,  
                       caption = paste0("Non-local and local responses for section 3 in country ", i),
                    col.names = 
                    c("Response\ncategory",
                      "Introduced domestic\nanimals are\na conservation\nconcern",
                      "Domestic animals\nfound in the\nprotected area",
                      "Domestic animals\nare recorded",
                      "Domestic animals\nhealth status\nis recorded")) %>% column_spec(1:5, width = c("2cm", "3cm", "2cm", rep("2cm", 2)))  %>% kable_styling(latex_options = "HOLD_position")
  #                 table.attr = "quarto-disable-processing=true") %>% 
  # kable_styling(c("striped", "bordered"), full_width = FALSE)


assign(x = paste0("section_3", "_table", i), value = out)

}

get("section_3_table1")
get("section_3_table2")
get("section_3_table3")
get("section_3_table4")


```
### Section 4: Health data storage practices in local surveys and non-local surveys containing protected areas in local responses
...
section_4$country<-paste0("country_",i) 
...
section_4$dead_wl_data_in_smart[grepl("Some", section_4$dead_wl_data_in_smart)]<-"Some"
section_4$dead_wl_data_in_smart[grepl("All", section_4$dead_wl_data_in_smart)]<-"Some"
section_4$dead_wl_data_in_smart[grepl("None", section_4$dead_wl_data_in_smart)]<-"None"
section_4$sick_wl_data_in_smart[grepl("Some", section_4$sick_wl_data_in_smart)]<-"Some"
section_4$sick_wl_data_in_smart[grepl("All", section_4$sick_wl_data_in_smart)]<-"Some"
section_4$sick_wl_data_in_smart[grepl("None", section_4$sick_wl_data_in_smart)]<-"None"
section_4$injured_wl_data_in_smart[grepl("Some", section_4$injured_wl_data_in_smart)]<-"Some"
section_4$injured_wl_data_in_smart[grepl("All", section_4$injured_wl_data_in_smart)]<-"Some"
section_4$injured_wl_data_in_smart[grepl("None", section_4$injured_wl_data_in_smart)]<-"None"


out<-kableExtra::kable(section_4,  
                       caption = paste0("Non-local and local responses for section 4 in country ", i),
                    col.names = 
                    c("Response\ncategory",
                      "Dead wildlife\nfound in patrols\nare recorded",
                      "Dead willdife\ndata in SMART",
                      ...
                      "Sick willdife\ndata in SMART",
                      "Injured wildlife\nfound in patrols\nis recorded",
                      "Injured willdife\ndata in SMART")) %>% column_spec(1:7, width = c("2cm", "2cm", "2cm", "2cm", "2cm", "2cm", "2cm"))   %>% kable_styling(latex_options = "HOLD_position")
  #                 table.attr = "quarto-disable-processing=true") %>% 
  # kable_styling(c("striped", "bordered"), full_width = FALSE)


assign(x = paste0("section_4", "_table", i), value = out)

}

get("section_4_table1")
get("section_4_table2")
get("section_4_table3")
get("section_4_table4")
