...
We developed a web-based questionnaire aimed at protected area managers. The survey had X sections. Under section 1, we asked managers to rank their perceptions regarding wildlife health 
and potential consequences of pathogen transmission among wildlife, domestic
animals and people in using a Likert scale:
...
Under section 2, we asked manager to rank the importance of introduced domestic animals 
for the conservation goals of the corresponding protected areas:
...
Responses could represent a single or multiple protected areas if respondents managed more than one of these sites. However, our analysis focused on responses representing one or two individual terrestrial protected areas to gain insights into specific local realities; Therefore, responses representing more than two protected areas were filtered out. The resulting dataset could have a specific protected area represented in two or more responses representing it singly, together with another protected area, or singly plus with another protected area. by responses representing it singly  completion and consistency of answers, and respondent's alignment with the intended target audience of the survey. 
...
Protected areas were classified as marine or terrestrial based on the World Database on Protected Areas (https://www.protectedplanet.net/en/thematic-areas/wdpa?tab=WDPA). Marine protected areas were removed.
