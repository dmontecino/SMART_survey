...
# all responses more than 5 are considered global. 

dat_modified$local<-NA
dat_modified$local[which(num_protected_areas_per_response>5)]<-FALSE
...
Global responses (>6) do not include just marine protected areas. For the remaining responses, the protected areas are classified as marine or terrestrial based on the World Database on Protected Areas (https://www.protectedplanet.net/en/thematic-areas/wdpa?tab=WDPA). Marine protected areas were removed.
...
#Answer 40 from the philippines are all marine protected areas
# and it is removed
# dat_modified$protected_area$'40'

dat_modified<-dat_modified[-which(names(dat_modified$protected_area)=='40'),]
