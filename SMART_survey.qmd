...
```{r open data and change column names}
#|echo: true
#|eval: true
#|warning: false
#|message: false

#link to the survey responses
link = paste0("https://docs.google.com/spreadsheets/",
              "d/1wiyZ_C6_t8HgUc5XBr9sZQ7FrxWUKKPje476EZfYF3w/edit?usp=sharing")
...
new.names<-c(
  ...
  "smart_connect",                  #42. Is SMART Connect available to manage 
                                    #and transfer information between SMART Desktop and SMART Mobile?"                                                                               
...
# data_from_r$healthy_wl_data_other[sapply(data_from_r$healthy_wl_data_other, is.null)]<-NA
# identical(unlist(data_from_r$healthy_wl_data_other),  data_from_r_modified$healthy_wl_data_other)


# Removing the score column
dat_modified=dat_modified %>% select(-score)
...
<!-- Classify terrestrial and marine and landscape cover (surface extension possibly) -->
```{r}
#| echo: false
#| eval: false

pa_per_row=lapply(sapply(data_from_r_modified$protected_area, strsplit, ", ", USE.NAMES = F), 
              function(x) data.frame(protected_area=x))

pa_per_row=lapply(pa_per_row, function(x) { x$type <- NA;return(x)})


pa_per_row[[1]]$type<-"terrestrial"
pa_per_row[[2]]$type<-rep("terrestrial", nrow(pa_per_row[[2]]))
pa_per_row[[3]]$type<-"terrestrial"
pa_per_row[[4]]$type<-"terrestrial"
pa_per_row[[5]]$type<-rep("terrestrial", nrow(pa_per_row[[5]]))
pa_per_row[[6]]$type<-"terrestrial"
pa_per_row[[7]]$type<-"terrestrial"
pa_per_row[[8]]$type<-"terrestrial"
pa_per_row[[9]]$type<-rep("terrestrial", nrow(pa_per_row[[9]]))
pa_per_row[[10]]$type<-rep("terrestrial", nrow(pa_per_row[[10]]))#   Unite de Surveillance et de Lutte Anti-Braconnage - Republic of Congo
pa_per_row[[11]]$type<-"terrestrial"
pa_per_row[[12]]$type<-c(rep("terrestrial", 2), "marine", "terrestrial", "aquatic", rep("terrestrial",2))
pa_per_row[[13]]$type<-rep("terrestrial", 2)
pa_per_row[[14]]$type<-"terrestrial"
pa_per_row[[15]]$type<-"terrestrial"
pa_per_row[[16]]$type<-rep("terrestrial", 2)
pa_per_row[[17]]$type<-"terrestrial"
pa_per_row[[18]]$type<-rep("terrestrial", 2)
pa_per_row[[19]]$type<-c(rep("terrestrial", 2), "marine", "terrestrial")
pa_per_row[[20]]$type<-"terrestrial"
pa_per_row[[21]]$type<-rep("terrestrial", nrow(pa_per_row[[21]]))
pa_per_row[[22]]$type<-rep("terrestrial", 3)
pa_per_row[[23]]$type<-rep("terrestrial", 2)
pa_per_row[[24]]$type<-"terrestrial"
pa_per_row[[25]]$type<-"terrestrial"
pa_per_row[[26]]$type<-"terrestrial"
pa_per_row[[27]]$type<-rep("marine", nrow(pa_per_row[[27]]))
pa_per_row[[28]]$type<-"terrestrial"
pa_per_row[[29]]$type<-rep("terrestrial", 2)
pa_per_row[[30]]$type<-"terrestrial"
pa_per_row[[31]]$type<-"terrestrial"
pa_per_row[[32]]$type<-"terrestrial"
pa_per_row[[33]]$type<-"terrestrial"
pa_per_row[[34]]$type<-"terrestrial"
pa_per_row[[35]]$type<-"terrestrial"
pa_per_row[[36]]$type<-"terrestrial"
pa_per_row[[37]]$type<-"terrestrial"
pa_per_row[[38]]$type<-"terrestrial"
pa_per_row[[39]]$type<-"terrestrial"
pa_per_row[[40]]$type<-"terrestrial"
pa_per_row[[41]]$type<-"terrestrial"
pa_per_row[[42]]$type<-"terrestrial"
pa_per_row[[43]]$type<-"terrestrial"
pa_per_row[[44]]$type<-"terrestrial"
pa_per_row[[45]]$type<-"terrestrial"
pa_per_row[[46]]$type<-"terrestrial"
pa_per_row[[47]]$type<-"marine"
pa_per_row[[48]]$type<-"terrestrial"
pa_per_row[[49]]$type<-"terrestrial"
pa_per_row[[50]]$type<-"terrestrial"
pa_per_row[[51]]$type<-"aquatic"
pa_per_row[[52]]$type<-"terrestrial"
pa_per_row[[53]]$type<-"terrestrial"
pa_per_row[[54]]$type<-"terrestrial"
pa_per_row[[55]]$type<-"terrestrial"
pa_per_row[[56]]$type<-"terrestrial"
pa_per_row[[57]]$type<-"aquatic"
pa_per_row[[58]]$type<-"terrestrial"
pa_per_row[[59]]$type<-"terrestrial"
pa_per_row[[60]]$type<-"terrestrial"
pa_per_row[[61]]$type<-"terrestrial"
pa_per_row[[62]]$type<-"terrestrial"
pa_per_row[[63]]$type<-"terrestrial"
pa_per_row[[64]]$type<-rep("terrestrial", 2)
pa_per_row[[65]]$type<-"marine"
pa_per_row[[66]]$type<-"terrestrial"
pa_per_row[[67]]$type<-"terrestrial"
pa_per_row[[68]]$type<-"marine"
pa_per_row[[69]]$type<-"marine"
pa_per_row[[70]]$type<-"marine"
pa_per_row[[71]]$type<-"marine"
pa_per_row[[72]]$type<-"marine"
pa_per_row[[73]]$type<-"marine"
pa_per_row[[74]]$type<-"aquatic"
pa_per_row[[75]]$type<-"aquatic"
pa_per_row[[76]]$type<-"marine"
pa_per_row[[77]]$type<-"marine"
pa_per_row[[78]]$type<-rep("terrestrial", nrow(pa_per_row[[78]]))
pa_per_row[[79]]$type<-rep("terrestrial", nrow(pa_per_row[[79]]))
pa_per_row[[80]]$type<-"terrestrial"
pa_per_row[[81]]$type<-rep("terrestrial", nrow(pa_per_row[[81]]))
pa_per_row[[82]]$type<-rep("terrestrial", 2)
pa_per_row[[83]]$type<-"terrestrial"
pa_per_row[[84]]$type<-"terrestrial"
pa_per_row[[85]]$type<-"terrestrial"
pa_per_row[[86]]$type<-"terrestrial"
pa_per_row[[87]]$type<-"terrestrial"
pa_per_row[[88]]$type<-"terrestrial"
pa_per_row[[89]]$type<-"terrestrial"
pa_per_row[[90]]$type<-rep("terrestrial", nrow(pa_per_row[[90]]))
pa_per_row[[91]]$type<-"terrestrial"
pa_per_row[[92]]$type<-"terrestrial"
pa_per_row[[93]]$type<-"terrestrial"
pa_per_row[[94]]$type<-"terrestrial"
pa_per_row[[95]]$type<-"terrestrial"
pa_per_row[[96]]$type<-"terrestrial"
pa_per_row[[97]]$type<-"terrestrial"
pa_per_row[[98]]$type<-"terrestrial"
pa_per_row[[99]]$type<-"terrestrial"
pa_per_row[[100]]$type<-rep("terrestrial", nrow(pa_per_row[[100]]))

#add the number of PAs associated with the survey
data_from_r_modified$number_of_pas<-sapply(pa_per_row, nrow)

#find the answers associated just with terrestrial PAs
index.of.terrestrial.only=sapply(pa_per_row, function(x) all(unique(x$type)=="terrestrial"), simplify = T)

#subset to the terrestrial PAs
terrestrial_data=data_from_r_modified[index.of.terrestrial.only,]

```

# R

## Terrestrial data cleaned
```{r}
terrestrial_data=data_from_r_modified
# terrestrial_data
```
...
##  Number of continents included

```{r}
#| echo: false
#| message: false

terrestrial_data$continent <- countrycode(sourcevar = as.data.frame(terrestrial_data)[, "country"],
                                  origin = "country.name",
                                  destination = "continent")

terrestrial_data %>% distinct(continent) %>% count()
...
#| echo: false
#| message: false
terrestrial_data %>% distinct(country) %>% count()

```
##  Number of protected areas included

```{r}
#| echo: false
#| message: false
sum(terrestrial_data$num_protected_areas)

```

##  Number of protected areas represented per continent

```{r}
#| echo: false
#| message: false

terrestrial_data %>% select(continent, num_protected_areas) %>% 
  group_by(continent) %>% 
  summarise(num_protected_areas = sum(num_protected_areas)) %>% arrange (-num_protected_areas)

```


##  Number of protected areas represented per country

```{r}
#| echo: false
#| message: false
terrestrial_data %>%  select(country, num_protected_areas) %>% 
  group_by(country) %>% 
  summarise(num_protected_areas = sum(num_protected_areas)) %>% arrange (-num_protected_areas)

```
##  Number of protected areas represented per continent per country

```{r}
#| echo: false
#| message: false
num_protected_areas_per_continent_country=
terrestrial_data %>%  select(continent, country, num_protected_areas) %>% 
  group_by(continent, country) %>% 
  summarise(num_protected_areas = sum(num_protected_areas)) %>% arrange (continent, country, -num_protected_areas)
...
##  Number of responses represented per continent per country

```{r}
#| echo: false
#| message: false
num_responses_per_continent_country=
terrestrial_data %>%  select(continent, country) %>% 
  count(continent, country)  %>% arrange (continent, country)

kableExtra::kbl(num_responses_per_continent_country, 
                    caption = "Number of responses per continent and country",
                    col.names = c("Continent", "Country", "Number")) %>%
      kableExtra::kable_paper(full_width = F) %>% 
      kableExtra::collapse_rows(columns = 1)
...
terrestrial_data_sick_dead = terrestrial_data[, c("sick_injured_found", "dead_found")] 
...
terrestrial_data_sick_dead$Response<-factor(x = terrestrial_data_sick_dead$Response, 
                                            levels = c("Never", 
                                                       "Very rarely", 
                                                       "Rarely", 
                                                       "Sometimes",
...
q_lab <- c("dead_found" = "Dead wildlife are\nfound during patrols",
           "sick_injured_found" = "Sick or injured wildlife\nare found during patrols")
...
ggplot(data = terrestrial_data_sick_dead) +
  ...
  geom_text(aes(Question, Freq, label = Freq), # add percentage
  ...
  coord_flip() +
  ggtitle("Dead and sick or injured wildlife are found during patrols" #,
          # subtitle = '% (Attitude) on "The government should __", with "Refused" removed'
          )

```
Rangers can detect morbidity and mortality.

Because they do not detect morbidity and mortality on every patrol, SMART for Health should not be a burden for their workflow. 

There is not huge difference on how often sick or injured versus dead wildlife is found during patrols: problem with the default data model in SMART which only considers carcasses. There could be a trend towards finding dead wildlife more often.

I dont think we should try to explain these findings by latitude, altitude, and landscape type (e..g, probably jungle habitats find less dead, sick, injured animals)
...
terrestrial_data_types_wildlife_recorded= terrestrial_data[, c("healthy_wl_recorded", "dead_wl_recorded", "injured_wl_recorded", "sick_wl_recorded")] 
...
terrestrial_data_dead_wildlife_found_versus_dead_wildlife_recorded = terrestrial_data[, c("dead_found", "dead_wl_recorded")] 

#make the columns factors so the count of zero appears in the table
terrestrial_data_dead_wildlife_found_versus_dead_wildlife_recorded$dead_found<-factor(terrestrial_data_dead_wildlife_found_versus_dead_wildlife_recorded$dead_found, levels = c("Never", 
                                                       "Very rarely", 
                                                       "Rarely", 
                                                       "Sometimes",
                                                       "Occasionally",
...
terrestrial_data_dead_wildlife_found_versus_dead_wildlife_recorded$dead_wl_recorded<-factor(terrestrial_data_dead_wildlife_found_versus_dead_wildlife_recorded$dead_wl_recorded, levels = c("Yes", "No"))
...
ggplot(data = terrestrial_data_dead_wildlife_found_versus_dead_wildlife_recorded %>% pivot_longer(cols=c("Yes", "No"))) +
  likert_theme +
  theme(strip.background  = element_blank(),
        axis.title = element_blank(),
        panel.background = element_blank(),
  ...
  coord_flip() +
  ggtitle("Dead wildlife recorded by frequecny dead wildlife is found during patrols" #,
          # subtitle = '% (Attitude) on "The government should __", with "Refused" removed'
          )
...
terrestrial_data_sick_injured_wildlife_found_versus_sick_injured_wildlife_recorded = terrestrial_data[, c("sick_injured_found", "sick_wl_recorded")] 

#make the columns factors so the count of zero appears in the table
terrestrial_data_sick_injured_wildlife_found_versus_sick_injured_wildlife_recorded$sick_injured_found<-factor(terrestrial_data_sick_injured_wildlife_found_versus_sick_injured_wildlife_recorded$sick_injured_found, levels = c("Never", 
 "Very rarely", 
 "Rarely", 
 "Sometimes",
 "Occasionally",
...
terrestrial_data_sick_injured_wildlife_found_versus_sick_injured_wildlife_recorded$sick_wl_recorded<-factor(terrestrial_data_sick_injured_wildlife_found_versus_sick_injured_wildlife_recorded$sick_wl_recorded, levels = c("Yes", "No"))
...
ggplot(data = terrestrial_data_sick_injured_wildlife_found_versus_sick_injured_wildlife_recorded %>% pivot_longer(cols=c("Yes", "No"))) +
  ...
  coord_flip() +
  ggtitle("Sick wildlife recorded by frequency sick or injured wildlife is found during patrols" #,
          # subtitle = '% (Attitude) on "The government should __", with "Refused" removed'
          )
