...
In agreement with the conservation biology scientific community, most respondents did "Agree" or "Strongly agree" with the affirmation "Introduced domestic animals (e.g., dogs, cats, cattle, pigs, cats) are a concern for the conservation goals of the protected areas where I work" and reported their presence in protected areas. Yet, 30% of this subgroup of managers reported that these animals are not recorded when found during patrols (n=15) and only a minority of the complementing 70% recording these animals also confirmed the registration of their health status. Historical and recent experiences have shown the impacts that multi-host species pathogens can have in livestock and wildlife, including H5N1 HPAI and Pest du petit ruminants virus. In a world with active land-use change and encroachment into natural habitats, including protected areas, domestic animals at these key human-wildlife-livestock interfaces should be part of the included in protected area monitoring planning, including the health component.
