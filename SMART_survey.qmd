...
We developed a web-based questionnaire aimed at protected area managers around the globe to learn about protected areas managers wildlife health perceptions; the monitoring of dead, sick, and injured wildlife and domestic animals in protected areas; health monitoring data storage practices; and the current status of SMART in protected areas. Protected area managers responses included 76 protected areas distributed in 19 countries and they suggest that: i) wildlife health tends to be considered relevant for the conservation goals of protected areas and there is a general understanding that pathogens can be transmitted among wildlife and humans and livestock and affect any of these groups; ii) dead, sick or injured wildlife might not be recorded if found during ranger patrols regardless of these animals being observed with certain frequency in protected areas. This is specially evident for sick and injured wildlife; iii) the recording of dead, sick, and injured wildlife found in patrols conducted in protected areas where these animals are registered follows different methodology, within and among sites, and the information collected is also variable; iv) domestic animals tend to be considered a concern for the conservation goals of protected areas, they tend found in them and recorded but their health status is usually not recorded; v) health data when collected might not be properly handled as many managers reported that this information is either not entered or is partially entered in a SMART database and the alternative choices are not adequate.
