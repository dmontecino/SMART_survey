...
There is a growing multi-sectoral recognition that the health of animals, people and  
their shared environment are intrinsic and inseparably linked such that the United Nations
Environment Programme has been integrated into the original partnership for One Health
among the World Health Organization, the Food and Agriculture Organisation of the United Nations, and 
the World Organisation for Animal Health in 2022. 

Indeed, high-risk areas of pathogen emergence  human-wildlife-livestock interfaces in disease emergence usually in rural areas , protected areas. Example : Ebola fever disease 
Fodused in human and livestock health generating fundamental gaps in global health security leaving aside willdife health  surveillance

Logistical challenges associated with surveillance in locations hard to access exacerbate the task's difficulty.
effective surveillance systems involving wildlife are uncommon, 

limited by resources,  in low- to high-income countries. howver, fillfundamental gaps in global health security by improving disease surveillance in remote rural areas is extremely needed 


Leveraging stakeholders who are already present at key interfaces offers an attractive strategy to establish baseline health surveillance at a minimal cost (IUCN and EcoHealth Alliance 2022). Rangers and other natural resource authorities (hereafter “rangers”), are responsible for field conservation and law enforcement in protected areas. On a global scale, rangers already patrol vast territories that encompass critical wildlife-livestock-human interfaces where they can detect injured, sick, and dead animals. While the concept of leveraging rangers for wildlife health surveillance is not new, there are relatively few documented independent initiatives that explicitly include rangers in scanning or syndromic surveillance. But these initiatives have effectively demonstrated their potential to provide data for trend assessments, initiate investigations, and trigger outbreak responses Montecino-Latorre et al. (2020) including for Ebola fever disease and Kuisma et al. (2019).

Technology can support the recruitment of rangers in syndromic health surveillance at protected areas. The “Spatial Monitoring and Reporting Tool” (SMART) is a suite of technological tools designed to manage protected areas supporting data management, the collection of digital data following user-built data models, and data communication among key stakeholders. SMART is currently used by over one thousand protected areas in more than one hundred countries under multiple languages (SMART Partnership n.d.). Its field-targeted technology, SMART Mobile, already supports rangers to seamlessly collect standardized data that can be timely transfer to out-of-the-field decision makers. SMART’s components, properties, and growing user base make it the best candidate to facilitate the proper engagement of rangers in health monitoring globally (Zimmerman et al. 2022; Worsley-Tonks et al. 2022) under a coomon set of standards but we are not aware this concept has been implemented with a global perspective or either locally (but see Discussion).

SMART-based leveraging of rangers in health surveillance represents a promising opportunity to generate a global network of health sentinels at key interfaces, empower rangers as planetary health workers, and fulfill fundamental gaps in global health security. However, to date there is a lack of baseline information to understand potential obstacles and assess the feasibility os this vision. Here we present the results of a survey targeting protected area managers worldwide belonging to the SMART user community aimed to assess: i) if they consider wildlife health relevant from a One Health perspective, ii) if dead, sick, or injured wildlife and domestic animals are observed in protected areas and recorded by rangers, iii) if these data (when collected) is stored in SMART databases, and iv) the current status of SMART components in protected areas. 
